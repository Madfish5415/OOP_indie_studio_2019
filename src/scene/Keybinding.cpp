...
void scene::Keybinding::init(ecs::Universe* universe, const std::string& pathTexture, ecs::component::Player* player)
{
    ...
    worldManager->addComponent(
        blackFilter, ecs::component::Image(gui, driver, keybinding::BLACKFILTER, new irr::core::position2d<irr::s32> {0, 0}));
    scene::Keybinding::images.push_back(blackFilter);

    ecs::Entity background = worldManager->createEntity();
    worldManager->addComponent(
        background, ecs::component::Image(gui, driver, keybinding::BACKGROUND, new irr::core::position2d<irr::s32> {460, 225}));
    scene::Keybinding::images.push_back(background);

    ecs::Entity playerImage = worldManager->createEntity();
    worldManager->addComponent(
        playerImage, ecs::component::Image(gui, driver, pathTexture, new irr::core::position2d<irr::s32> {460 + 85, 225 + 85}));
    scene::Keybinding::images.push_back(playerImage);

    {
        auto entity = createPushButton(worldManager, gui, new irr::core::rect<irr::s32>(1230, 350, 1230 + 75, 350 + 75), nullptr,
    ...
    {
        auto entity = createPushButton(worldManager, gui, new irr::core::rect<irr::s32>(1230, 427, 1230 + 75, 427 + 75), nullptr,
    ...
    {
        auto entity = createPushButton(worldManager, gui, new irr::core::rect<irr::s32>(1153, 427, 1153 + 75, 427 + 75), nullptr,
    ...
    {
        auto entity = createPushButton(worldManager, gui, new irr::core::rect<irr::s32>(1307, 427, 1307 + 75, 427 + 75), nullptr,
    ...
    {
        auto entity = createPushButton(worldManager, gui, new irr::core::rect<irr::s32>(1230, 650, 1230 + 75, 650 + 75), nullptr,
    ...
    createButton(worldManager, gui, new irr::core::rect<irr::s32>(835, 905, 835 + 250, 905 + 100), nullptr, GUI_SELECT_KB_BACK,
        back::NORMAL, back::HOVER, back::PRESSED);
}

void scene::Keybinding::destroy(ecs::Universe* universe)
{
    for (auto& entity : scene::Keybinding::images) {
        auto& img = universe->getWorldManager("Keybinding")->getComponent<ecs::component::Image>(entity);
        img.image->remove();
    }
    for (auto& entity : scene::Keybinding::buttons) {
